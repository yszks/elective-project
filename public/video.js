...
document.getElementById('join-btn').addEventListener('click', function () { document.getElementById('login-btn').style.display = 'none' });
document.getElementById('leave-btn').addEventListener('click', function () { document.getElementById('head-buttons').style.display = 'none' });
...
document.getElementById('leave-btn').addEventListener('click', function () { document.getElementById('head-buttons').style.display = 'flex' });
